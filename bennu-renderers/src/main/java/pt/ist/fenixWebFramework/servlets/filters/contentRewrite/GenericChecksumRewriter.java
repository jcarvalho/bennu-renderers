...
public final class GenericChecksumRewriter {
                        ...
                        if (indexOfHrefBodyStart >= 0) {
                            ...
                            if (indexOfHrefBodyEnd >= 0) {
                                ...
                                if ((indexOfJavaScript < 0 || indexOfJavaScript > indexOfHrefBodyEnd)
                                    ...
                                    } else if (indexOfMailto >= 0) {
                                        nextIndex = indexOfMailto;
                                    } else if (indexOfHttp >= 0) {
                                        nextIndex = indexOfHttp;
                                    } else if (indexOfHttps >= 0) {
                                        nextIndex = indexOfHttps;
                                    } else {
    ...
    private boolean isPrefixed(final String source, final int indexOfTagOpen) {
        return source.regionMatches(indexOfTagOpen - LENGTH_OF_NO_CHECKSUM_PREFIX, source, 0, LENGTH_OF_NO_CHECKSUM_PREFIX);
    }
