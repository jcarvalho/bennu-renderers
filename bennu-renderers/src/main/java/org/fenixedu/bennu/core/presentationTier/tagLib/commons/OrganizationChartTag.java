...
public class OrganizationChartTag extends BodyTagSupport {
    ...
    private static final String TABLE_OPEN_PREFIX =
    ...
    public void doInitBody() throws JspException {
        ...
        if (rowIndex > elementRowIndex) {
            if (elementRowIndex >= 0 && rowIndex < organizationChart.size() - 1) {
                ...
                if ((rowSize == 4 && columnIndex == 2) || (rowSize == 6 && columnIndex == 3)
    ...
    private void printColumnOpen(final int colSpan, final String width, final String style, final String align)
            throws JspException {
        print("<td");
        if (colSpan > 1) {
