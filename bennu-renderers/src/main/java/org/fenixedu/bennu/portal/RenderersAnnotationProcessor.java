        ...
        if (classes != null) {
            ...
            for (Class<?> type : classes) {
                ...
                if (functionality != null) {
                    ...
                    functionalityClasses.put(type, new Functionality("struts", type.getName(), functionality.path(),
                            functionality.accessGroup(), title, description));
                }
                ...
                if (application != null) {
                    ...
                    applicationClasses.put(type,
                            new Application("struts", type.getName(), application.path(), application.accessGroup(), title,
                                    description));
                }
            }
